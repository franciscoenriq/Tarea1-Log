...
Rectangulo calcularMBR(const std::vector<Rectangulo>& listaRectangulos) {
    ...
    uint32_t minX = listaRectangulos[0].inf_izq.x;
    uint32_t maxX = listaRectangulos[0].sup_der.x;
    uint32_t minY = listaRectangulos[0].inf_izq.y;
    uint32_t maxY = listaRectangulos[0].sup_der.y;
